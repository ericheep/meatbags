...
void OrbbecPulsar::checkMotorSpeed() {
	...
	switch(guiMotorSpeed) {
		case 1: speedValue = 900; break;
		case 2: speedValue = 1200; break;
		case 3: speedValue = 1500; break;
		case 4: speedValue = 1800; break;
		case 5: speedValue = 2400; break;
		default: speedValue = 900; break;
	}
